...
public class ImageCacheLight {
    private ImageCacheLight() {
    }
    ...
    public static Image getImageFullScreenDark() {
        if (imageFullScreenDark == null) {
            imageFullScreenDark = new Image(ImageCacheLight.class.getResource("/images/dashboard/title-pane/full-screen-dark.png").toExternalForm());
        }
    ...
    public static Image getImageUnFullScreenDark() {
        if (imageUnFullScreenDark == null) {
            imageUnFullScreenDark = new Image(ImageCacheLight.class.getResource("/images/dashboard/title-pane/un-full-screen-dark.png").toExternalForm());
        }
    ...
    public static Image getImageMinimizeDark() {
        if (imageMinimizeDark == null) {
            imageMinimizeDark = new Image(ImageCacheLight.class.getResource("/images/dashboard/title-pane/minimize-dark.png").toExternalForm());
        }
    ...
    public static Image getImageCloseRed() {
        if (imageCloseRed == null) {
            imageCloseRed = new Image(ImageCacheLight.class.getResource("/images/dashboard/title-pane/close-dark-red-2.png").toExternalForm(), 32, 32, true, true);
        }
    ...
    public static Image getImageCloseRedDefault() {
        if (imageCloseRedDefault == null) {
            imageCloseRedDefault = new Image(ImageCacheLight.class.getResource("/images/dashboard/title-pane/close-dark-red.png").toExternalForm(), 32, 32, true, true);
        }
    ...
    public static Image getImageDefaultDark() {
        if (imageDefaultDark == null) {
            imageDefaultDark = new Image(ImageCacheLight.class.getResource("/images/dashboard/title-pane/default-dark.png").toExternalForm());
        }
    ...
    public static Image getImageCircleDark() {
        if (imageCircleDark == null) {
            imageCircleDark = new Image(ImageCacheLight.class.getResource("/images/dashboard/chat-contacts/circle-dark.png").toExternalForm());
        }
    ...
    public static Image getImageCircleCloseDark() {
        if (imageCircleCloseDark == null) {
            imageCircleCloseDark = new Image(ImageCacheLight.class.getResource("/images/dashboard/chat-contacts/circle-close-dark.png").toExternalForm());
        }
    ...
    public static Image getImageCircleCloseDarkHover() {
        if (imageCircleCloseDarkHover == null) {
            imageCircleCloseDarkHover = new Image(ImageCacheLight.class.getResource("/images/dashboard/chat-contacts/circle-close-dark-hover.png").toExternalForm());
        }
    ...
    public static Image getImageCircleUnLockDark() {
        if (imageCircleUnLockDark == null) {
            imageCircleUnLockDark = new Image(ImageCacheLight.class.getResource("/images/dashboard/chat-contacts/un-lock-dark.png").toExternalForm());
        }
    ...
    public static Image getImageCircleUnLockDarkHover() {
        if (imageCircleUnLockDarkHover == null) {
            imageCircleUnLockDarkHover = new Image(ImageCacheLight.class.getResource("/images/dashboard/chat-contacts/un-lock-dark-hover.png").toExternalForm());
        }
    ...
    public static Image getImageBackgroundMono() {
        if (imageBackgroundMono == null) {
            imageBackgroundMono = new Image(ImageCacheLight.class.getResource("/images/mv-mono.png").toExternalForm());
        }
    ...
    public static Image getImageAllChats() {
        if (imageAllChats == null) {
            imageAllChats = new Image(ImageCacheLight.class.getResource("/images/dashboard/setting/all-chats-light.png").toExternalForm());
        }
    ...
    public static Image getImageAllChatsHover() {
        if (imageAllChatsHover == null) {
            imageAllChatsHover = new Image(ImageCacheLight.class.getResource("/images/dashboard/setting/all-chats-hover.png").toExternalForm());
        }
    ...
    public static Image getImageMenu() {
        if (imageMenu == null) {
            imageMenu = new Image(ImageCacheLight.class.getResource("/images/dashboard/setting/menu-light.png").toExternalForm());
        }
        return imageMenu;
    }
    ...
    public static Image getImageMenuHover() {
        if (imageMenuHover == null) {
            imageMenuHover = new Image(ImageCacheLight.class.getResource("/images/dashboard/setting/menu-hover.png").toExternalForm());
        }
    ...
    public static Image getImageChat() {
        if (imageChat == null) {
            imageChat = new Image(ImageCacheLight.class.getResource("/images/dashboard/setting/dark/chat-dark.png").toExternalForm());
        }
        return imageChat;
    }
    public static Image getImageChatHover() {
        if (imageChatHover == null) {
            imageChatHover = new Image(ImageCacheLight.class.getResource("/images/dashboard/setting/chat-hover.png").toExternalForm());
        }
    ...
    public static Image getImageCirclePerson() {
        if (imageCirclePerson == null) {
            imageCirclePerson = new Image(ImageCacheLight.class.getResource("/images/dashboard/setting/circle-person-light.png").toExternalForm(), 32, 32, true, true);
        }
    ...
    public static Image getImageCirclePersonHover() {
        if (imageCirclePersonHover == null) {
            imageCirclePersonHover = new Image(ImageCacheLight.class.getResource("/images/dashboard/setting/circle-person-hover.png").toExternalForm(), 32, 32, true, true);
        }
    ...
    public static Image getImageEyeDark() {
        if (imageEyeDark == null) {
            imageEyeDark = new Image(ImageCacheLight.class.getResource("/images/login/eye-dark.png").toExternalForm());
        }
        return imageEyeDark;
    }
    ...
    public static Image getImageEyeDarkHover() {
        if (imageEyeDarkHover == null) {
            imageEyeDarkHover = new Image(ImageCacheLight.class.getResource("/images/login/eye-dark-hover.png").toExternalForm());
        }
    ...
    public static Image getImageUnEyeDark() {
        if (imageUnEyeDark == null) {
            imageUnEyeDark = new Image(ImageCacheLight.class.getResource("/images/login/un-eye-dark.png").toExternalForm());
        }
    ...
    public static Image getImageUnEyeDarkHover() {
        if (imageUnEyeDarkHover == null) {
            imageUnEyeDarkHover = new Image(ImageCacheLight.class.getResource("/images/login/un-eye-dark-hover.png").toExternalForm());
        }
